    ...
    <div className="bg-[#f7f8fa] min-h-screen">
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12 pb-8 sm:pb-10 text-center">
        ...
        <div className="relative max-w-lg mx-auto">
          <div className="flex items-center w-full h-12 rounded-full bg-white border border-slate-200 shadow-sm focus-within:ring-2 focus-within:ring-indigo-500/20 focus-within:border-indigo-300 transition-shadow">
