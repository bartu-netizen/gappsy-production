      ...
      <OnboardingShell step={stepIndex} onBack={showBack ? goBack : undefined}>
        ...
        {step === 'growth_upsell' && (
          <div className="flex-1 w-full max-w-4xl mx-auto px-5 sm:px-8 py-3 sm:py-2.5">
            ...
            <div className="relative">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white overflow-hidden">
                <div className="grid grid-cols-[1fr_62px_76px] sm:grid-cols-[1fr_112px_136px]">
                  ...
                  <div className="px-2 pt-1.5 pb-1.5 sm:pt-2 sm:pb-2 text-center border-b border-slate-100">
                    ...
                    <div className="mt-0.5 flex items-end justify-center gap-0.5">
                      <span className="text-xl sm:text-[26px] font-bold text-[#0B1221]">$89</span>
                      <span className="text-[11px] sm:text-[13px] text-slate-400 mb-1">/mo</span>
                    </div>
                  </div>
                  <div className="px-2 pt-1.5 pb-1.5 sm:pt-2 sm:pb-2 text-center bg-[#EEF0FE]/70 border-t-2 border-l-2 border-r-2 border-b border-[#4F47E6]">
                    <p className="text-[12.5px] sm:text-sm font-semibold text-[#4F47E6]">Yearly</p>
                    <div className="mt-0.5 flex items-end justify-center gap-0.5">
                      <span className="text-xl sm:text-[26px] font-bold text-[#0B1221]">$699</span>
                  ...
                  {[...GROWTH_MONTHLY_FEATURES.map((item) => ({ item, yearlyOnly: false })), ...GROWTH_YEARLY_ONLY_FEATURES.map((item) => ({ item, yearlyOnly: true }))].map((row, i) => (
                    <div key={row.item} className="contents">
                      ...
                      <div className={`py-[3px] sm:py-1 flex items-center justify-center ${i % 2 === 1 ? 'bg-slate-100' : ''}`}>
                        {row.yearlyOnly ? (
                          <Minus className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-slate-300" aria-hidden="true" />
                        ) : (
                          <Check className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#4F47E6]" aria-hidden="true" />
                        )}
                      </div>
                      <div className="py-[3px] sm:py-1 flex items-center justify-center bg-[#EEF0FE]/70 border-l-2 border-r-2 border-[#4F47E6]">
                        <Check className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#4F47E6]" aria-hidden="true" />
                      </div>
                    </div>
                  ))}
            ...
            <p className="mt-1.5 text-center text-[11.5px] sm:text-[12.5px] text-slate-400">Billed via Stripe. Cancel anytime.</p>
