      ...
      <OnboardingShell step={stepIndex} onBack={showBack ? goBack : undefined}>
        ...
        {step === 'growth_upsell' && (
          <div className="flex-1 w-full max-w-4xl mx-auto px-5 sm:px-8 py-3 sm:py-4">
            <div className="text-center mb-2.5 sm:mb-2">
              <p className="text-[13px] sm:text-sm font-semibold text-[#4F47E6] mb-0.5">Upgrade to Growth</p>
              <h1 className="text-xl sm:text-[30px] font-bold tracking-tight text-[#0B1221] leading-tight">
                Ready to get seen?
              </h1>
              <p className="hidden sm:block mt-1 text-[13.5px] sm:text-base text-slate-500 leading-snug">
            ...
            <div className="relative">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white overflow-hidden">
                <div className="grid grid-cols-[1fr_62px_76px] sm:grid-cols-[1fr_112px_136px]">
                  ...
                  <div className="px-2 pt-2 pb-2 sm:pt-2.5 sm:pb-2.5 text-center border-b border-slate-100">
                    <p className="text-[12.5px] sm:text-sm font-semibold text-slate-500">Monthly</p>
                    <div className="mt-0.5 flex items-end justify-center gap-0.5">
                      <span className="text-xl sm:text-[28px] font-bold text-[#0B1221]">$89</span>
                      <span className="text-[11px] sm:text-[13px] text-slate-400 mb-1">/mo</span>
                    </div>
                  </div>
                  <div className="px-2 pt-2 pb-2 sm:pt-2.5 sm:pb-2.5 text-center bg-[#EEF0FE]/70 border-t-2 border-l-2 border-r-2 border-b border-[#4F47E6]">
                    <p className="text-[12.5px] sm:text-sm font-semibold text-[#4F47E6]">Yearly</p>
                    <div className="mt-0.5 flex items-end justify-center gap-0.5">
                      <span className="text-xl sm:text-[28px] font-bold text-[#0B1221]">$699</span>
                      <span className="text-[11px] sm:text-[13px] text-slate-400 mb-1">/yr</span>
                    </div>
                  </div>
                  ...
                  {[...GROWTH_MONTHLY_FEATURES.map((item) => ({ item, yearlyOnly: false })), ...GROWTH_YEARLY_ONLY_FEATURES.map((item) => ({ item, yearlyOnly: true }))].map((row, i) => (
                    <div key={row.item} className="contents">
                      <div className={`py-[3px] sm:py-2 pl-2.5 pr-1 sm:pl-4 sm:pr-2 flex items-center text-[10.5px] sm:text-sm leading-[1.15] sm:leading-tight text-slate-600 ${i % 2 === 1 ? 'bg-slate-100' : ''}`}>{row.item}</div>
                      <div className={`py-[3px] sm:py-2 flex items-center justify-center ${i % 2 === 1 ? 'bg-slate-100' : ''}`}>
                        {row.yearlyOnly ? (
                          <Minus className="w-3 h-3 sm:w-4 sm:h-4 text-slate-300" aria-hidden="true" />
                        ) : (
                          <Check className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#4F47E6]" aria-hidden="true" />
                        )}
                      </div>
                      <div className="py-[3px] sm:py-2 flex items-center justify-center bg-[#EEF0FE]/70 border-l-2 border-r-2 border-[#4F47E6]">
                        <Check className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#4F47E6]" aria-hidden="true" />
                      </div>
                    </div>
                  ))}
                  ...
                  <div className="p-1.5 sm:p-2">
                    <button
                      ...
                      className="w-full flex items-center justify-center px-2 py-2 sm:py-2.5 rounded-lg text-[12.5px] sm:text-sm font-semibold text-[#0B1221] bg-slate-100 hover:bg-slate-200 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
                    >
                      {checkingOutInterval === 'month' ? <Loader2 className="w-3.5 h-3.5 animate-spin" aria-hidden="true" /> : 'Continue'}
                    </button>
                  </div>
                  <div className="p-1.5 sm:p-2 bg-[#EEF0FE]/70 border-l-2 border-r-2 border-b-2 border-[#4F47E6]">
                    <button
                      type="button"
                      onClick={() => handleGrowthCheckout('year')}
                      disabled={checkingOutInterval !== null}
                      className="w-full flex items-center justify-center px-2 py-2 sm:py-2.5 rounded-lg text-[12.5px] sm:text-sm font-semibold text-white bg-[#4F47E6] hover:opacity-90 disabled:opacity-40 disabled:cursor-not-allowed transition-opacity active:scale-[0.99]"
                    >
            ...
            <p className="mt-2 text-center text-[11.5px] sm:text-[12.5px] text-slate-400">Billed via Stripe. Cancel anytime.</p>
