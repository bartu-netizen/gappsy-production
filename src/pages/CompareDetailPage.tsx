    ...
    return (
      <div className="bg-[#f7f8fa] min-h-screen">
        ...
        <main className="max-w-4xl mx-auto px-4 py-20 text-center">
          ...
          <Link to="/compare" className="inline-flex items-center gap-1.5 text-blue-600 font-semibold hover:text-blue-700">
          ...
          <div className="min-w-0 space-y-14">
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-2.5">
                <Link to={`/tools/${aRow.slug}`} className="inline-flex items-center gap-2 bg-white border border-[#eef0f3] rounded-full px-4 py-2 text-sm font-medium text-slate-600 hover:border-blue-200 hover:text-blue-600 transition-colors">
                  Full {aRow.name} review
                </Link>
                <Link to={`/tools/${bRow.slug}`} className="inline-flex items-center gap-2 bg-white border border-[#eef0f3] rounded-full px-4 py-2 text-sm font-medium text-slate-600 hover:border-blue-200 hover:text-blue-600 transition-colors">
                  Full {bRow.name} review
                </Link>
                {factsA.primaryCategory && (
                  <Link
                    to={`/tool-categories/${factsA.primaryCategory.slug}`}
                    className="inline-flex items-center gap-2 bg-white border border-[#eef0f3] rounded-full px-4 py-2 text-sm font-medium text-slate-600 hover:border-blue-200 hover:text-blue-600 transition-colors"
                  >
