          ...
          <div className="min-w-0 space-y-14">
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-2.5">
                <Link to={`/tools/${aRow.slug}`} className="inline-flex items-center gap-2 bg-white border border-[#eef0f3] rounded-full px-4 py-2 text-sm font-medium text-slate-600 hover:border-indigo-200 hover:text-indigo-600 transition-colors">
                  Full {aRow.name} review
                </Link>
                <Link to={`/tools/${bRow.slug}`} className="inline-flex items-center gap-2 bg-white border border-[#eef0f3] rounded-full px-4 py-2 text-sm font-medium text-slate-600 hover:border-indigo-200 hover:text-indigo-600 transition-colors">
                  Full {bRow.name} review
                </Link>
                {factsA.primaryCategory && (
                  <Link
                    to={`/tool-categories/${factsA.primaryCategory.slug}`}
                    className="inline-flex items-center gap-2 bg-white border border-[#eef0f3] rounded-full px-4 py-2 text-sm font-medium text-slate-600 hover:border-indigo-200 hover:text-indigo-600 transition-colors"
                  >
