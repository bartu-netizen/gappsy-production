  ...
  return (
    <div className="bg-[#f7f8fa] min-h-screen">
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 pt-6 sm:pt-10 pb-10 sm:pb-14 text-center">
        <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-indigo-600 mb-3">Tools Directory</p>
        ...
        <div className="relative max-w-xl mx-auto">
          <div className="flex items-center w-full h-14 rounded-full bg-white border border-gray-200 shadow-sm focus-within:ring-2 focus-within:ring-[#0A1735] transition-shadow">
                  ...
                  {recentTools.map((tool) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-semibold text-[#0B1221] group-hover:text-indigo-600 transition-colors truncate">
                          {tool.name}
                        </p>
                  ...
                  {tags.map((tag) => {
                    ...
                    return (
                      <Link
                        ...
                        className={`inline-flex items-center gap-1.5 bg-white border border-[#eef0f3] rounded-full font-medium text-slate-600 hover:text-indigo-600 hover:border-indigo-200 transition-colors ${scaleClass}`}
                      >
