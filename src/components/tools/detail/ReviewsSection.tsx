...
const AVATAR_COLORS = ['bg-[#E0E3FC] text-[#4F47E6]', 'bg-violet-100 text-violet-600', 'bg-emerald-100 text-emerald-600', 'bg-amber-100 text-amber-700', 'bg-rose-100 text-rose-600'];
      ...
      {reviews.length > 0 && (
        <div className="flex flex-col sm:flex-row sm:items-center gap-6 bg-slate-50 rounded-2xl p-5 mb-5">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl text-sm font-semibold text-white bg-[#4F47E6] hover:bg-[#4338CA] transition-colors shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4F47E6] focus-visible:ring-offset-2"
          >
