        ...
        {sections.map((section) => (
          <li key={section.id}>
            <a
              ...
              className={`block text-sm py-1.5 pl-3 pr-2 border-l-2 rounded-r-md transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-inset ${
                activeId === section.id
                  ? 'border-blue-500 bg-blue-50/70 text-blue-600 font-medium'
