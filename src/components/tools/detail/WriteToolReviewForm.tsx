    ...
    <form onSubmit={handleSubmit} className="rounded-2xl border border-[#eef0f3] bg-white p-5 sm:p-6 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          onClick={onClose}
          aria-label="Close"
          className="w-7 h-7 rounded-full flex items-center justify-center text-slate-400 hover:text-slate-600 hover:bg-slate-100 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
        >
          ...
          {Array.from({ length: 5 }).map((_, i) => {
            ...
            return (
              <button
                ...
                className="p-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded"
              >
