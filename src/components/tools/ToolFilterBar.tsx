      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <div className="relative">
          <select
            ...
            className="appearance-none pl-3 pr-8 py-2 rounded-full border border-slate-200 bg-white text-xs font-medium text-slate-600 hover:border-slate-300 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 cursor-pointer"
          >
  ...
  return (
    <button
      ...
      className={`px-3 py-1.5 rounded-full text-xs font-medium border transition-colors ${
        active ? 'bg-indigo-50 border-indigo-200 text-indigo-700' : 'border-slate-200 text-slate-500 hover:text-slate-700 hover:border-slate-300'
      }`}
    >
      {children}
    </button>
  ...
  return (
    <div className="relative">
      <select
        ...
        className={`appearance-none pl-3 pr-7 py-1.5 rounded-full border text-xs font-medium cursor-pointer focus:outline-none focus:ring-2 focus:ring-indigo-500/20 ${
          value ? 'bg-indigo-50 border-indigo-200 text-indigo-700' : 'border-slate-200 text-slate-500 hover:border-slate-300 bg-white'
        }`}
      >
