...
import type { RoundupHighlight } from '../../data/roundupContent/types';

export default function RoundupHighlights({ toolNames, highlights }: { toolNames: Record<string, string>; highlights: RoundupHighlight[] }) {
