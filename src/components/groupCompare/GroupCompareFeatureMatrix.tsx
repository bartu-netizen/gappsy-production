...
import type { FeatureStatus, GroupComparisonFeatureMatrixGroup } from '../../data/groupComparisonContent/types';
...
export default function GroupCompareFeatureMatrix({ toolNames, groups }: { toolNames: Record<string, string>; groups: GroupComparisonFeatureMatrixGroup[] }) {
