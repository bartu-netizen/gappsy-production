      ...
      >
        <div className="flex items-center gap-3 px-4 sm:px-5 h-14 sm:h-16 border-b border-slate-100 shrink-0">
          ...
          <input
            ...
            spellCheck={false}
          />
          {loading && <Loader2 className="w-4 h-4 text-blue-500 animate-spin shrink-0" aria-hidden="true" />}
              ...
              {recentSearches.map((term) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-left text-sm transition-colors ${isActive ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:bg-slate-50'}`}
                  >
                  ...
                  {grouped.tools.map((row) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-start gap-3 px-3 py-2.5 rounded-xl text-left transition-colors ${isActive ? 'bg-blue-50' : 'hover:bg-slate-50'}`}
                      >
                        {row.logo ? (
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-1.5">
                            ...
                            {row.verified && <ShieldCheck className="w-3.5 h-3.5 text-blue-500 shrink-0" />}
                  ...
                  {grouped.categories.map((row) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-left transition-colors ${isActive ? 'bg-blue-50' : 'hover:bg-slate-50'}`}
                      >
                  ...
                  {(() => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center justify-between gap-2 px-3 py-2.5 rounded-xl text-left text-sm font-medium transition-colors ${isActive ? 'bg-blue-50 text-blue-700' : 'text-blue-600 hover:bg-slate-50'}`}
                      >
