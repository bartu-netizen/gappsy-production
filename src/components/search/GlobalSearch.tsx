      ...
      >
        <div className="flex items-center gap-3 px-4 sm:px-5 h-14 sm:h-16 border-b border-slate-100 shrink-0">
          ...
          <input
            ...
            spellCheck={false}
          />
          {loading && <Loader2 className="w-4 h-4 text-[#0A1735] animate-spin shrink-0" aria-hidden="true" />}
        ...
        <div className="flex-1 overflow-y-auto py-2">
              ...
              {recentSearches.map((term) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-left text-sm transition-colors ${isActive ? 'bg-[#EEF1F7] text-[#132952]' : 'text-slate-600 hover:bg-slate-50'}`}
                  >
          ...
          {isEmptyQuery && recentSearches.length === 0 && (
            <div className="px-6 py-14 text-center">
              <div className="w-11 h-11 rounded-2xl bg-[#EEF1F7] flex items-center justify-center mx-auto mb-3">
                <Search className="w-5 h-5 text-[#0A1735]" />
              </div>
                  ...
                  {grouped.tools.map((row) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-start gap-3 px-3 py-2.5 rounded-xl text-left transition-colors ${isActive ? 'bg-[#EEF1F7]' : 'hover:bg-slate-50'}`}
                      >
                        {row.logo ? (
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-1.5">
                            ...
                            {row.verified && <ShieldCheck className="w-3.5 h-3.5 text-[#0A1735] shrink-0" />}
                  ...
                  {grouped.categories.map((row) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-left transition-colors ${isActive ? 'bg-[#EEF1F7]' : 'hover:bg-slate-50'}`}
                      >
                        <div className="w-9 h-9 rounded-lg bg-[#EEF1F7] flex items-center justify-center shrink-0">
                          <FolderTree className="w-4 h-4 text-[#0A1735]" />
                        </div>
                        <div className="min-w-0 flex-1">
                  ...
                  {(() => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center justify-between gap-2 px-3 py-2.5 rounded-xl text-left text-sm font-medium transition-colors ${isActive ? 'bg-[#EEF1F7] text-[#132952]' : 'text-[#0A1735] hover:bg-slate-50'}`}
                      >
