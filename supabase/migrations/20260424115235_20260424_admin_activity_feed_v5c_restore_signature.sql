/*
  # Restore original get_admin_activity_feed signature + keep v5b hardening

  Edge function admin-activity-feed/index.ts calls with:
    p_limit, p_state_slug, p_agency_id, p_window_minutes
  And consumes columns:
    event_group, funnel_stage, readable_label, state_name (plus basics)

  This restores that contract while adding the hardening fields:
    intent_stage, identity_method, identity_confidence, identity_source, identity_debug
*/
